...
module.exports = async (bot, reaction, user) => {
    console.log(user.username + "  reaction remove:\n" + reaction);
    ...
    await member.roles.remove(roleIds, `Роли-за-реакцию: Пользователь отказался от этих ролей в ${message.channel.name}`)
